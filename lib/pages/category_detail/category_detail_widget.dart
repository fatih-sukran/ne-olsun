...
class CategoryDetailWidget extends StatefulWidget {
  ...
  final CategoriesRecord? categoryId;
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            widget.categoryId!.categoryName,
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        functions
                            .getTotalPrice(FFAppState().products.toList())
                            .toString(),
          ...
          child: StreamBuilder<List<ProductsRecord>>(
            stream: queryProductsRecord(
              queryBuilder: (productsRecord) => productsRecord.where(
                  'category_id',
                  isEqualTo: widget.categoryId!.reference),
            ),
                            ...
                            Row(
                              ...
                              children: [
                                CounterWidget(
                                  ...
                                  productDocumentId: listViewProductsRecord,
                                ),
                              ],
                            ),
                          ],
